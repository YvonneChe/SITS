...
!
      ...
      double precision FR1,FR2,FR3,W,RHOI
...
!
      write(unit,'(A)') 'REMARK  Written by Amber 14, PMEMD, EMAP'
      do ires = 1,nres
...
!
      ...
      double precision FR1,FR2,FR3,W
      double precision BS1(8),BS2(8),BS3(8)
      double precision VAL0,VAL0A
      INTEGER alloc_err
...
!
   ...
   include 'mpif.h'
      ...
      double precision BS1(8),BS2(8),BS3(8)
      double precision DBS1(8),DBS2(8),DBS3(8)
      double precision XI,YI,ZI,XJ,YJ,ZJ
      double precision AMASSI,RHOI,ENRIGM
      double precision CFACT,CFACTX,CFACTY,CFACTZ,FR1,FR2,FR3,W
...
!
      ...
      double precision CFACT,CFACTX,CFACTY,CFACTZ,FR1,FR2,FR3,T2,W
