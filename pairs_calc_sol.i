#ifdef BUILD_PAIRS_CALC_EFV_SOL
#ifdef BUILD_PAIRS_CALC_NOVEC_2CUT_SOL
!*******************************************************************************
!
! Internal Subroutine:  pairs_calc_efv_2cut_sol
!
...
subroutine pairs_calc_efv_2cut_sol(img_frc, img_crd, img_qterm, ef_tbl, eed_cub, &
...
!*******************************************************************************
!
! Internal Subroutine:  pairs_calc_efv_sol
!
! Description:  Direct force computation on one atom.  Different implementations
!               are covered by conditional compilation in this file.
!*******************************************************************************

subroutine pairs_calc_efv_sol(img_frc, img_crd, img_qterm, ef_tbl, eed_cub, &
                          ico, ipairs_sublst, img_iac, cn1, cn2, x_tran)

#endif /* BUILD_PAIRS_CALC_NOVEC_2CUT_SOL */
#endif /* BUILD_PAIRS_CALC_EFV_SOL */

#ifdef BUILD_PAIRS_CALC_FV_SOL
#ifdef BUILD_PAIRS_CALC_NOVEC_2CUT_SOL
!*******************************************************************************
!
! Internal Subroutine:  pairs_calc_fv_2cut_sol
!
! Description:  Direct force computation on one atom.  Different implementations
!               are covered by conditional compilation in this file.
!*******************************************************************************

subroutine pairs_calc_fv_2cut_sol(img_frc, img_crd, img_qterm, f_tbl, eed_cub, &
                              ico, ipairs_sublst, img_iac, cn1, cn2, x_tran)
...
!*******************************************************************************
!
! Internal Subroutine:  pairs_calc_fv_sol
!
! Description:  Direct force computation on one atom.  Different implementations
!               are covered by conditional compilation in this file.
!*******************************************************************************

subroutine pairs_calc_fv_sol(img_frc, img_crd, img_qterm, f_tbl, eed_cub, &
                         ico, ipairs_sublst, img_iac, cn1, cn2, x_tran)

#endif /* BUILD_PAIRS_CALC_NOVEC_2CUT_SOL */
#endif /* BUILD_PAIRS_CALC_FV_SOL */

#ifdef BUILD_PAIRS_CALC_F_SOL
#ifdef BUILD_PAIRS_CALC_NOVEC_2CUT_SOL
!*******************************************************************************
!
! Internal Subroutine:  pairs_calc_f_2cut_sol
!
! Description:  Direct force computation on one atom.  Different implementations
!               are covered by conditional compilation in this file.
!*******************************************************************************

subroutine pairs_calc_f_2cut_sol(img_frc, img_crd, img_qterm, f_tbl, eed_cub, &
                             ico, ipairs_sublst, img_iac, cn1, cn2, x_tran)
...
!*******************************************************************************
!
! Internal Subroutine:  pairs_calc_f_sol
!
! Description:  Direct force computation on one atom.  Different implementations
!               are covered by conditional compilation in this file.
!*******************************************************************************

subroutine pairs_calc_f_sol(img_frc, img_crd, img_qterm, f_tbl, eed_cub, &
                        ico, ipairs_sublst, img_iac, cn1, cn2, x_tran)

#endif /* BUILD_PAIRS_CALC_NOVEC_2CUT_SOL */
#endif /* BUILD_PAIRS_CALC_F_SOL */
...
#undef NEED_VIR
#ifdef BUILD_PAIRS_CALC_NOVEC_2CUT_SOL
end subroutine pairs_calc_efv_2cut_sol
#else
end subroutine pairs_calc_efv_sol
#endif
#endif /* BUILD_PAIRS_CALC_EFV_SOL */
...
#undef NEED_VIR
#ifdef BUILD_PAIRS_CALC_NOVEC_2CUT_SOL
end subroutine pairs_calc_fv_2cut_sol
#else
end subroutine pairs_calc_fv_sol
#endif
#endif /* BUILD_PAIRS_CALC_FV_SOL */

#ifdef BUILD_PAIRS_CALC_F_SOL
#ifdef BUILD_PAIRS_CALC_NOVEC_2CUT_SOL
end subroutine pairs_calc_f_2cut_sol
#else
end subroutine pairs_calc_f_sol
#endif
#endif /* BUILD_PAIRS_CALC_F_SOL */
