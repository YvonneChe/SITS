...
!Modified by Lijiang Yang
    deallocate(gbl_sluipairs)
    deallocate(gbl_solipairs)
    deallocate(gbl_interipairs)
...
!    allocate(gbl_ipairs(ipairs_maxsize), stat = alloc_failed)
    allocate(gbl_sluipairs(ipairs_maxsize), &
             ...
             gbl_interipairs(ipairs_maxsize), stat = alloc_failed)
!--------------------------------------------------------------------------------
...
#ifdef CUDA
    ! Reupload charges if forcing neutrality    
